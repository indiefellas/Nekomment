/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc -c ../api/wrangler.jsonc` (hash: a21455fac3fde14fbfe124aedc085460)
// Runtime types generated with workerd@1.20250617.0 2025-06-27 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TURNSTILE_KEY: "0x4AAAAAABiz9O-8UcrMo56C";
		API_URL: string;
		NEKOMMENT_API: Service<import("../api/src/index").InternalService>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_KEY" | "API_URL">> {}
}
