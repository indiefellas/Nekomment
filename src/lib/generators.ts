...
export function genDefaultTemplate(theme: string) {
    ...
    https://docs.cmt.nkko.link/Pages/Variables
    ...
    https://cmt.nkko.link/dash/widgets#js or the Nekomment API docs at
    https://api.cmt.nkko.link/docs
-->
...
<style>
    /* See https://docs.cmt.nkko.link/Pages/Styling for more info */
</style>`
    }
}