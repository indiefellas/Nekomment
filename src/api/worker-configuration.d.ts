/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f1cf9413f5213fdbafd4fbf21b290cb9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION" | "ENV">> {}
}
